...
?>
    ...
    <div class="bg-primary2 pb-10">
        <div class="flex justify-between container mx-auto py-2">
            <h1 class="text-3xl font-bold py-4 container mx-auto text-secondary2 text-center sm:text-left">Genre <?= $genre ?></h1>
        </div>
        <div class="container mx-auto flex flex-wrap  justify-center">
            ...
            <?php } }else{
                ?>
                    <div class="text-center text-4xl text-secondary2 font-bold py-10"> Belum ada Film Dengan Genre <?= $genre ?> </div>
                <?php
            } ?>
        </div>
    </div>